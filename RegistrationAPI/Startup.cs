...
namespace RegistrationAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddScoped<IpartDetailRepository, PartDetailRepository>();


            services.AddScoped<IRegistrationService, RegistractionService>();
            //services.AddScoped<IPartDetailService, PartDetailService>();
